...
<div id="telescope" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-stretch py-4 header">
            ...
            <button class="btn btn-muted mr-3 d-flex align-items-center py-2" v-on:click.prevent="toggleTheme" title="theme">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor" class="icon" v-if="darkMode == false ">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor" class="icon" v-if="darkMode == true || darkMode == null">
